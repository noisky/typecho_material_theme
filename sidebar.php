	...
	<a class="panel-heading" onclick="$('.amadeus_about').slideToggle()" href="javascript:;">
		...
		<aside class="amadeus_about clearfix">
			<div class="photo-background">
			    <div class="photo-background" style="background:url(https://cdn.jsdelivr.net/gh/noisky/typecho_material_theme@latest/img/about.jpg) no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
			<div class="photo-wrapper text-center">
			<a href="https://ffis.me/about.html" title="关于饭饭">
                <img src="https://cdn.jsdelivr.net/gh/noisky/typecho_material_theme@latest/img/author.png" alt="关于饭饭" />
            </a>
