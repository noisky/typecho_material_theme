...
<link rel="stylesheet" href="//static.ffis.me/stylesheet/customs.css?v=2019112201" />
...
<a class="navbar-brand" id="logo" href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title() ?></a></div>
<div class="navbar-collapse collapse navbar-responsive-collapse">
<ul class="nav navbar-nav">
<li<?php if($this->is('index')): ?> class="active"<?php endif; ?>>
<a href="<?php $this->options->siteUrl(); ?>"><span class="mdi-action-home">&nbsp;</span><?php $this->options->title() ?></a></li>
<!--顶部导航显示分类-->
...
<li><a href="<?php $this->options->weibolink() ?>" rel="nofollow" target="_blank"><img class="top_weibo" src="https://static.ffis.me/img/weibo.png">&nbsp;Weibo</a></li>
<?php endif; ?>
</ul>
<!--END-->
</div><!-- /.nav-collapse -->
